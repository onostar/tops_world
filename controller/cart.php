<?php
    ...
    // if(isset($_POST['add_to_cart'])){
       ...
       /*  $item_restaurant = ucwords(htmlspecialchars(stripslashes($_POST['cart_item_restaurant']))); */
        ...
        $check_user = $connectdb->prepare("SELECT * FROM cart WHERE item_name = :item_name AND customer_email = :customer_email");
        ...
        if($check_user->rowCount() > 0){
            ...
            $add_cart = $connectdb->prepare("INSERT INTO cart (item_name, quantity, item_price, customer_email) VALUES (:item_name, :quantity, :item_price, :customer_email)");
