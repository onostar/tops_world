...
<body id="mainBody">
    <header class="admin_header">
        ...
        <div class="login">
            ...
            <div class="login_option" id="accounts">
                <div>
    ...
    <main class="admin_main">
        <aside id="user_aside" class="main_menu">
            <div class="login">
                <button id="loginDiv" title="Profile"><i class="far fa-user"></i> 
                    <?php 
                        /* $statement = $connectdb->prepare("SELECT * FROM users WHERE email = :email");
                        $statement->bindvalue('email', $user);
                        $statement->execute();
        ...
        <section id="contents">
            ...
            <div id="dashboard">
                ...
                <div class="cards" id="clientCard3">
                    <a href="javascript:void(0)">
            ...
            <div class="summaryReports">
                ...
                <div class="customers_attended">
                    ...
                    <?php
                        $get_customers = $connectdb->prepare("SELECT SUM(item_price) AS total_sales FROM orders WHERE order_status = 1 AND delivery_date = CURDATE() AND restaurant = :restaurant");
                        $get_customers->bindvalue("restaurant", $my_restaurant);
                    ...
                    <table class="sum_table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                <?php 
                                    $get_total_customers = $connectdb->prepare("SELECT item_name FROM orders WHERE order_date = CURDATE() AND restaurant = :restaurant GROUP BY order_number");
                                    $get_total_customers->bindvalue("restaurant", $my_restaurant);
            ...
            <!-- cancelled deliveries list -->
             <div id="cancelledDeliveries" class="management">
                ...
                <div class="cancelled_data">
                    <h3>Cancelled Deliveries for Today</h3>
                    <hr>
                    <div class="search">
                    ...
                    <table id="cancelledTable">
                        ...
                        <?php
                            ...
                            $select_cancel = $connectdb->prepare("SELECT users.first_name, users.last_name, users.email, users.address, users.city, orders.order_id, orders.customer_email, orders.item_name, orders.quantity, orders.item_price, orders.restaurant, orders.order_date, orders.delivery_date FROM users, orders WHERE orders.restaurant = :restaurant AND users.email = orders.customer_email AND orders.order_status = -1 AND orders.delivery_date = CURDATE() ORDER BY orders.order_date DESC");
            ...
            <div id="highestSellingItems" class="management">
                <div class="select_date">
                    <form method="POST">
                        <div class="from_to_date">
                            <label>Select From Date</label><br>
                            <input type="date" name="uHighest_from_date" id="uHighest_from_date"><br>
                        </div>
                        <div class="from_to_date">
                            <label>Select to Date</label><br>
                            <input type="date" name="uHighest_to_date" id="uHighest_to_date"><br>
                        </div>
                        <button type="submit" name="uSearch_highest" id="uSearch_highest">Search</button>
                    </form>
                </div>
                <div class="new_highest_data">
                    ...
                    <table id="highestItemsTable">
                        ...
                        <?php
                            $n = 1;
                            $todays_date = date("Y-m-d");
                            $select_items = $connectdb->prepare("SELECT item_name, item_price, restaurant, delivery_date, SUM(quantity) AS total_quantity, SUM(item_price) AS total_amount FROM orders WHERE order_status = 1 AND delivery_date = CURDATE() AND restaurant = :restaurant GROUP BY item_name ORDER BY total_quantity DESC");
